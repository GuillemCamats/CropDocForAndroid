...
class DemosActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        locJapan.add(Locations(LatLng(43.31157834371925,142.5278503313331),"Type: Rust | Accuracy: 0.99",null))
        ...
        locUsa.add(Locations(LatLng(47.71191232766577,-122.1478821701581),"Type: Rust | Accuracy: 0.99",null))
